...
```{r}
# @VS: wird noch geändert, nicht beachten
...
# VS wenn ich es richtig verstanden habe, ist das nur der Plot? Dann fehlt noch die Statistik dazu. z.B. Permanova oder Anova
# VS Im Meeting hatten wir auch darüber gesprochen, dass du im Moment nur die Woche codest und das Treatment daneben steht
# VS Ich würde vorschlagen Zeitpunkt und Treatment als Farbe und Form zu definieren. Dabei sollte das in der Hypothese wichtigere als Farbe gecoded werden. Das sieht man schneller / besser
# VS zudem solltest du rot und grün in einem Plot vermeiden, weil Farbenblinde das nicht unterscheiden können
